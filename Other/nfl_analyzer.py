...
class NFLAnalyzer:
    def __init__(self):
        ...
        self.model = "llama3.2"  # Updated model name
        self.model_params = {
    ...
    async def get_final_recommendation(self, analyses: Dict[str, str], home_team: str, away_team: str) -> str:
